...
if ui_lang == "ru":
    st.warning(L.get("ru_latin_notice", "Пожалуйста, заполняйте латиницей (A–Z, 0–9) в соответствии с документами. Поля с кириллицей будут автоматически транслитерированы при генерировании документов."))
